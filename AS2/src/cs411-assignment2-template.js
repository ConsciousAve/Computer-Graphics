...
var boardW= 20.0;          // board width
var boardH= 20.0;          // board height
...
function toggleRotateMode(){
  pauseRotation = 1-pauseRotation;
  console.log('rotationMode = %d', pauseRotation);
}


function toggleRotationNormalMode(){
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////// YOUR CODE HERE //////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
// Toggle rotation to be normal to the path mode
//////////////////////////////////////////////////////////////////////////////////
pauseRotationNormal = 1-pauseRotationNormal;
console.log('rotationNormal = %d' , pauseRotationNormal);
}
...
function animate() 
{
  ...
  else if (!pauseRotationNormal)
  {
    var xDiff = curPosX-prevPosX;
    var yDiff = curPosY-prevPosY;
    var xNorm = yDiff*(-1);
    var yNorm = xDiff;
    var AngleDeg = Math.atan2(yNorm-yDiff,xNorm-xDiff)*180/Math.PI;
    if(Math.floor(AngleDeg)<0) {
      AngleDeg += 360.0;
    }
    curRotAngle = Math.floor(AngleDeg)+45;
...
function main() 
{
  ...
  var pauseRotationBtn = document.getElementById('RotationButton');
  pauseRotationBtn.addEventListener('click', toggleRotateMode);

  var pauseRotationNormalBtn = document.getElementById('RotationNormalButton');
  pauseRotationNormalBtn.addEventListener('click', toggleRotationNormalMode);
  //////////////////////////////////////////////////////////////////////////////////
  //////////////////////////////// YOUR CODE HERE //////////////////////////////////
  //////////////////////////////////////////////////////////////////////////////////
